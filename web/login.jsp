            ...
            <div class="login" id="login_frame">
                <form action="login" method="get">
                    <div class="account_password">
                        <input class="account" type="text" name="user" placeholder="邮箱/手机号码/小米ID" autocomplete="off"/>
                        <input class="password" type="password" name="password" placeholder="密码" autocomplete="off"/>
                    </div>
        ...
        <div id="register_frame">
            <form action="register" method="get">
                <div class="register_account_password">
                    <input class="account" type="text" name="user" placeholder="邮箱/手机号码/小米ID" autocomplete="off"/>
                    <input class="password" type="password" name="password" placeholder="密码" autocomplete="off"/>
                    <input class="password2" type="password" name="password2" placeholder="来，再输一次" autocomplete="off"/>
